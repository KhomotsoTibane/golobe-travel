...
const Footer = () => {
  return (
    <footer className="relative mx-auto mt-40 w-full bg-primary-400 px-6 md:px-12 lg:px-20 h-96">
      <div className="w-full flex items-center justify-center">
        <div className="absolute -top-30 grid w-full max-w-screen-2xl gap-4 rounded-[20px] h-84 bg-primary-100 p-6 md:grid-cols-2 md:p-10">
          <div className="flex flex-col justify-center gap-4 max-w-xl">
            <h2 className="trade__bold text-xl sm:text-2xl md:text-3xl">Subscribe Newsletter</h2>
        ...
        <div className="absolute  bottom-0 grid gap-10 lg:grid-cols-8  w-full max-w-screen-2xl mx-auto ">
